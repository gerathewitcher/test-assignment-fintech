...
Revision ID: 642dc06f12db
Revises:
Create Date: 2026-02-22 11:20:05.139777
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_organization_activity_id"),
        "organization",
        ["activity_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_organization_activity_id"), table_name="organization")
